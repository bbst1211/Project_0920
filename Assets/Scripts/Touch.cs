        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (Physics.Raycast(ray, out hit, 100))
            {
                ...
                if (hitObj.tag == "Head")
                {
                    animator.SetBool("TouchHead"
                    , true);
                    animator.SetBool("Face_Happy"
                    , true);
                    animator.SetBool("Face_Angry"
                    , false);
                ...
                else if (hitObj.tag == "Arm")
                {
                    ...
                    univoice.Play();
                    MsgDisp.ShowMessage("현재 날짜 및 시간: " + currentTime.ToString());
                }
